...
const PerfilPage: React.FC = () => {
  ...
  const [perfil, setPerfil] = useState({
    ...
    descripcion: 'Soy una profesional con más de 10 años de experiencia en servicios de limpieza y organización del hogar.',
  });
          ...
          {editMode ? (
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div>
                  <label htmlFor="nombre" className="block text-sm font-medium text-[var(--color-text)]">Nombre</label>
                  <input
                    type="text"
                    id="nombre"
                    name="nombre"
                ...
                <div>
                  <label htmlFor="telefono" className="block text-sm font-medium text-[var(--color-text)]">Teléfono</label>
                  <input
                    type="tel"
                    id="telefono"
                    name="telefono"
                ...
                <div>
                  <label htmlFor="direccion" className="block text-sm font-medium text-[var(--color-text)]">Dirección</label>
                  <input
                    type="text"
                    id="direccion"
                    name="direccion"
                ...
                <div>
                  <label htmlFor="descripcion" className="block text-sm font-medium text-[var(--color-text)]">Descripción</label>
                  <textarea
                    id="descripcion"
                    name="descripcion"
                    rows={4}
